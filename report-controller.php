...
if(!empty($_POST['submitReport'])) {
	...
	$agentName = $_POST['partner'];
	$reportText = $_POST['reportText'];
	
	// get agentID using agentName
...
if(!empty($_POST['addAction'])) {
	...
	// fetch data from Form
	$actionDescription = $_POST['WHOtheme'];
	$allianceName = $_POST['themeNumber'];
	$workgroupName = $_POST['strategy'];
	...
	$meeting = new classProgramme();
	$result = $meeting->addProgramme($actionDescription,$programmeID,$allianceID,$workGroupID);
