...
class classReports
{
	public function addReport($agentID,$reportText,$reportOwner){
		
		// get the current date
		$reportDate = date("Y/m/d");
		
		// $sql_statement = "INSERT INTO reports (partnerID, report, reportOwner) VALUES($partnerID, $reportText, $owner)";

		$sql_statement = "insert into reports (partnerID, reportDate, report, reportOwner ) ";
		$sql_statement .= "values (";
		$sql_statement .= "'".$agentID."', '".$reportDate."','".$reportText."', '".$reportOwner."'";
		$sql_statement .= ")";
